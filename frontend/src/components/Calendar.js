                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1 text-xs font-medium text-systemix-deep-blue dark:text-systemix-electric hover:bg-systemix-electric/10 rounded-lg transition-colors"
                          title="Edit Event"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1 text-xs font-medium text-systemix-purple dark:text-systemix-pink hover:bg-systemix-purple/10 rounded-lg transition-colors"
                          title="Share Event"
                        >
                          <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1 text-xs font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                        title="Delete Event"
                      >
                        <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
